...
namespace JotunnModStub.Common {
    ...
    internal static class PieceConfigDrawer {
        ...
        internal static void Attach(JotunnPiece.JotunnBuildPiece jp) {
        ...
        private static void Draw(JotunnPiece.JotunnBuildPiece jp) {
            ConfigDrawHelpers.EnsureStyles();
            GUILayout.BeginVertical(GUI.skin.box);
        ...
        private static void DrawCostEditor(JotunnPiece.JotunnBuildPiece jp) {
